    ...
    return (
          ...
          cn(
            ...
            'button-ring relative flex select-none flex-row items-center justify-center whitespace-nowrap rounded-md border disabled:cursor-not-allowed',
            {
              ...
              'border-transparent bg-rose-800 text-white hover:bg-rose-900':
                variant === 'danger',
              'hover:bg-neutral-1000 border-neutral-800 bg-neutral-900 text-neutral-100 disabled:border-transparent disabled:text-neutral-500 hover:disabled:bg-opacity-100':
                variant === 'plain',
              'hover:bg-neutral-1000 border-neutral-800 text-neutral-100 disabled:border-transparent disabled:text-neutral-500 hover:disabled:bg-opacity-100':
                variant === 'bordered',
              'button-ring-light border-neutral-900/10 text-neutral-900 hover:bg-neutral-100 disabled:opacity-50':
                variant === 'borderedWhite',
              'hover:bg-neutral-1000 border-transparent text-neutral-100 disabled:text-neutral-500 hover:disabled:bg-opacity-100':
                variant === 'ghost',
      ...
      >
        ...
        {loading && !loadingMessage && (
          <i className="absolute bottom-0 left-0 right-0 top-0 flex justify-center">
            <LoadingDots
              className={cn({
